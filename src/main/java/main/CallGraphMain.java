...
import graphs.CouplingStaticCallGraph;
		...
		try {
			switch(userInput) {
				...
				case "3":
					return;
				case "4":
					CouplingStaticCallGraph graph = CouplingStaticCallGraph.createCouplingGraph(TEST_PROJECT_PATH);
					graph.print();
					return;
				case QUIT:
